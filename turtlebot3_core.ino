...
* Robot's name
*******************************************************************************/
String robot_name = "robot1_";
//(char *)(robot_name + "wheel_left_joint").c_str()
...
* Subscriber
*******************************************************************************/
ros::Subscriber<geometry_msgs::Twist> cmd_vel_sub("cmd_vel", commandVelocityCallback);    //(char *)(robot_name + "wheel_right_joint").c_str() robot1
...
ros::Publisher sensor_state_pub("sensor_state", &sensor_state_msg);   //(char *)(robot_name + "wheel_right_joint").c_str() robot1

// IMU of Turtlebot3
sensor_msgs::Imu imu_msg;
ros::Publisher imu_pub("imu", &imu_msg);  //(char *)(robot_name + "wheel_right_joint").c_str() robot1

// Command velocity of Turtlebot3 using RC100 remote controller
geometry_msgs::Twist cmd_vel_rc100_msg;
ros::Publisher cmd_vel_rc100_pub("cmd_vel_rc100", &cmd_vel_rc100_msg);    //(char *)(robot_name + "wheel_right_joint").c_str() robot1

nav_msgs::Odometry odom;
ros::Publisher odom_pub("odom", &odom); //(char *)(robot_name + "wheel_right_joint").c_str() robot1

sensor_msgs::JointState joint_states;
ros::Publisher joint_states_pub("joint_states", &joint_states); //(char *)(robot_name + "wheel_right_joint").c_str() robot1
...
float odom_pose[3];
char *joint_states_name[] = {"wheel_left_joint", "wheel_right_joint"};    // wheel_left_joint   wheel_right_joint  robot1
